    ...
    <div className="p-6 space-y-5 max-w-[1200px]">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">Log your buy, sell, and dividend events</p>
        </div>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={(v) => field.onChange(parseInt(v))} value={field.value ? field.value.toString() : ""}>
                        <FormControl>
                          <SelectTrigger data-testid="select-tx-asset">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input data-testid="input-tx-date" type="date" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input data-testid="input-tx-quantity" type="number" step="any" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input data-testid="input-tx-price" type="number" step="any" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input data-testid="input-tx-notes" placeholder="Optional" {...field} value={field.value ?? ""} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  {sorted.map((tx) => {
                    ...
                    return (
                      <tr key={tx.id} className="border-b border-border/50 hover:bg-muted/20 transition-colors" data-testid={`tx-row-${tx.id}`}>
                        ...
                        <td className="px-3 py-3">
                          <Badge variant={(TX_TYPE_COLORS[tx.type] as any) ?? "secondary"} className="capitalize text-xs">
                            {tx.type}
                          </Badge>
                        </td>
